...
type
  ...
  private
    FalignmentPatternCenters: TIntArray;
    ...
    /// </summary>
    class var VERSION_DECODE_INFO: TIntArray;
  ...
  public
    constructor Create(const versionNumber: Integer;
      const alignmentPatternCenters: TIntArray;
    ...
    property alignmentPatternCenters: TIntArray
...
begin
  Result := TArray<TVersion>.Create(
    ...
    TVersion.Create(2, TIntArray.Create(6, 18),
    ...
    TVersion.Create(3, TIntArray.Create(6, 22),
    ...
    TVersion.Create(4, TIntArray.Create(6, 26),
    ...
    TVersion.Create(5, TIntArray.Create(6, 30),
    ...
    TVersion.Create(6, TIntArray.Create(6, 34),
    ...
    TVersion.Create(7, TIntArray.Create(6, 22, 38),
    TArray<TECBlocks>.Create(TECBlocks.Create(20,
    ...
    TVersion.Create(8, TIntArray.Create(6, 24, 42),
    ...
    TVersion.Create(9, TIntArray.Create(6, 26, 46),
    ...
    TVersion.Create(10, TIntArray.Create(6, 28, 50),
    TArray<TECBlocks>.Create(TECBlocks.Create(18,
    ...
    TVersion.Create(11, TIntArray.Create(6, 30, 54),
    TArray<TECBlocks>.Create(TECBlocks.Create(20,
    ...
    TVersion.Create(12, TIntArray.Create(6, 32, 58),
    TArray<TECBlocks>.Create(TECBlocks.Create(24,
    ...
    TVersion.Create(13, TIntArray.Create(6, 34, 62),
    TArray<TECBlocks>.Create(TECBlocks.Create(26,
    ...
    TVersion.Create(14, TIntArray.Create(6, 26, 46, 66),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(15, TIntArray.Create(6, 26, 48, 70),
    ...
    TVersion.Create(16, TIntArray.Create(6, 26, 50, 74),
    TArray<TECBlocks>.Create(TECBlocks.Create(24,
    ...
    TVersion.Create(17, TIntArray.Create(6, 30, 54, 78),
    ...
    TVersion.Create(18, TIntArray.Create(6, 30, 56, 82),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(19, TIntArray.Create(6, 30, 58, 86),
    TArray<TECBlocks>.Create(TECBlocks.Create(28,
    ...
    TVersion.Create(20, TIntArray.Create(6, 34, 62, 90),
    TArray<TECBlocks>.Create(TECBlocks.Create(28,
    ...
    TVersion.Create(21, TIntArray.Create(6, 28, 50, 72, 94),
    TArray<TECBlocks>.Create(TECBlocks.Create(28,
    ...
    TVersion.Create(22, TIntArray.Create(6, 26, 50, 74, 98),
    TArray<TECBlocks>.Create(TECBlocks.Create(28,
    ...
    TVersion.Create(23, TIntArray.Create(6, 30, 54, 78, 102),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(24, TIntArray.Create(6, 28, 54, 80, 106),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(25, TIntArray.Create(6, 32, 58, 84, 110),
    TArray<TECBlocks>.Create(TECBlocks.Create(26,
    ...
    TVersion.Create(26, TIntArray.Create(6, 30, 58, 86, 114),
    TArray<TECBlocks>.Create(TECBlocks.Create(28,
    ...
    TVersion.Create(27, TIntArray.Create(6, 34, 62, 90, 118),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(28, TIntArray.Create(6, 26, 50, 74, 98, 122),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(29, TIntArray.Create(6, 30, 54, 78, 102, 126),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(30, TIntArray.Create(6, 26, 52, 78, 104, 130),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(31, TIntArray.Create(6, 30, 56, 82, 108, 134),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(32, TIntArray.Create(6, 34, 60, 86, 112, 138),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(33, TIntArray.Create(6, 30, 58, 86, 114, 142),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(34, TIntArray.Create(6, 34, 62, 90, 118, 146),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(35, TIntArray.Create(6, 30, 54, 78, 102, 126, 150),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(36, TIntArray.Create(6, 24, 50, 76, 102, 128, 154),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(37, TIntArray.Create(6, 28, 54, 80, 106, 132, 158),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(38, TIntArray.Create(6, 32, 58, 84, 110, 136, 162),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(39, TIntArray.Create(6, 26, 54, 82, 110, 138, 166),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
    ...
    TVersion.Create(40, TIntArray.Create(6, 30, 58, 86, 114, 142, 170),
    TArray<TECBlocks>.Create(TECBlocks.Create(30,
...
begin
  TVersion.VERSION_DECODE_INFO := TIntArray.Create($7C94, $85BC, $9A99,
